...
public final class FragmentSplashBinding implements ViewBinding {
  ...
  private FragmentSplashBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView ivLogo,
      @NonNull View logoBadge, @NonNull ProgressBar progressBar, @NonNull TextView tvAppName,
      @NonNull TextView tvTagline) {
    this.rootView = rootView;
    this.ivLogo = ivLogo;
    this.logoBadge = logoBadge;
  ...
  public static FragmentSplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.logoBadge;
      View logoBadge = ViewBindings.findChildViewById(rootView, id);
      if (logoBadge == null) {
        break missingId;
      }
      ...
      return new FragmentSplashBinding((ConstraintLayout) rootView, ivLogo, logoBadge, progressBar,
          tvAppName, tvTagline);
    }
