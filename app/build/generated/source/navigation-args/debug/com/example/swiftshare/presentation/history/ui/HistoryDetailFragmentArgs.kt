...
public data class HistoryDetailFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): HistoryDetailFragmentArgs {
      bundle.setClassLoader(HistoryDetailFragmentArgs::class.java.classLoader)
      ...
      return HistoryDetailFragmentArgs(__sessionId)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): HistoryDetailFragmentArgs {
      val __sessionId : String?
