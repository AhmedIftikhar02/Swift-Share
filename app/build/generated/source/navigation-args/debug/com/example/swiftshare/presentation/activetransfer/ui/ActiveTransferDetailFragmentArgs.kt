...
public data class ActiveTransferDetailFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): ActiveTransferDetailFragmentArgs {
      bundle.setClassLoader(ActiveTransferDetailFragmentArgs::class.java.classLoader)
      ...
      return ActiveTransferDetailFragmentArgs(__sessionId)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        ActiveTransferDetailFragmentArgs {
      val __sessionId : String?
