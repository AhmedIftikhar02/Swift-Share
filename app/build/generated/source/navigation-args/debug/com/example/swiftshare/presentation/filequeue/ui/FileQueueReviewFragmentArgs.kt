...
public data class FileQueueReviewFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): FileQueueReviewFragmentArgs {
      bundle.setClassLoader(FileQueueReviewFragmentArgs::class.java.classLoader)
      ...
      return FileQueueReviewFragmentArgs(__endpointId)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        FileQueueReviewFragmentArgs {
      val __endpointId : String?
