...
public abstract class Hilt_HistoryDetailFragment extends NavPlaceholderFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_HistoryDetailFragment(String screenTitle,
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HistoryDetailFragment_GeneratedInjector) this.generatedComponent()).injectHistoryDetailFragment(UnsafeCasts.<HistoryDetailFragment>unsafeCast(this));
    }
  }
