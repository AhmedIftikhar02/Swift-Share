...
public abstract class Hilt_PinPairingFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PinPairingFragment_GeneratedInjector) this.generatedComponent()).injectPinPairingFragment(UnsafeCasts.<PinPairingFragment>unsafeCast(this));
    }
  }
