...
public abstract class Hilt_TransferHubFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TransferHubFragment_GeneratedInjector) this.generatedComponent()).injectTransferHubFragment(UnsafeCasts.<TransferHubFragment>unsafeCast(this));
    }
  }
