...
public abstract class Hilt_ActiveTransferDetailFragment extends NavPlaceholderFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ActiveTransferDetailFragment(String screenTitle,
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ActiveTransferDetailFragment_GeneratedInjector) this.generatedComponent()).injectActiveTransferDetailFragment(UnsafeCasts.<ActiveTransferDetailFragment>unsafeCast(this));
    }
  }
