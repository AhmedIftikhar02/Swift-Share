...
public abstract class Hilt_ConnectionConfirmationDialog<VB extends ViewBinding> extends BaseDialog<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_ConnectionConfirmationDialog(
      Function1<? super LayoutInflater, ? extends VB> bindingInflater) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ConnectionConfirmationDialog_GeneratedInjector) this.generatedComponent()).injectConnectionConfirmationDialog(UnsafeCasts.<ConnectionConfirmationDialog>unsafeCast(this));
    }
  }
