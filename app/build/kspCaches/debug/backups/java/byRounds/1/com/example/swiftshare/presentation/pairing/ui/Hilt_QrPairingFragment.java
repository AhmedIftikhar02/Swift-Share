...
public abstract class Hilt_QrPairingFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((QrPairingFragment_GeneratedInjector) this.generatedComponent()).injectQrPairingFragment(UnsafeCasts.<QrPairingFragment>unsafeCast(this));
    }
  }
