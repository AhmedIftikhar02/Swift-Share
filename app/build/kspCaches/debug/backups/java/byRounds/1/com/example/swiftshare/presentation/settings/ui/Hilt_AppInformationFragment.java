...
public abstract class Hilt_AppInformationFragment extends NavPlaceholderFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AppInformationFragment(String screenTitle,
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AppInformationFragment_GeneratedInjector) this.generatedComponent()).injectAppInformationFragment(UnsafeCasts.<AppInformationFragment>unsafeCast(this));
    }
  }
