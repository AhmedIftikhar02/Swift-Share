...
public abstract class Hilt_DeviceNameSetupFragment extends NavPlaceholderFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DeviceNameSetupFragment(String screenTitle,
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DeviceNameSetupFragment_GeneratedInjector) this.generatedComponent()).injectDeviceNameSetupFragment(UnsafeCasts.<DeviceNameSetupFragment>unsafeCast(this));
    }
  }
