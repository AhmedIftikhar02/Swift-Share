...
public abstract class Hilt_PermissionRationaleFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  Hilt_PermissionRationaleFragment(
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PermissionRationaleFragment_GeneratedInjector) this.generatedComponent()).injectPermissionRationaleFragment(UnsafeCasts.<PermissionRationaleFragment>unsafeCast(this));
    }
  }
