...
public abstract class Hilt_FileQueueReviewFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FileQueueReviewFragment_GeneratedInjector) this.generatedComponent()).injectFileQueueReviewFragment(UnsafeCasts.<FileQueueReviewFragment>unsafeCast(this));
    }
  }
